                        ...
                        <li class="active a">
                            <a href="#" title="">PRODUCTS</a>
                                <ul class="sub-menu">
                                    ...
                                    <li class="active"><a href="${contextRoot}/FrontPage/Shop-cart.html" title="">Shop Cart</a></li>
                                </ul><!-- /.sub-menu -->
                        </li>
                        <li class="active">
                            <a href="#" title="">BLOG</a>
                            ...
                            <div id="tab-description" class="tab-content">
                                ...
                                <div class="cart-btn">
                                    <div class="btn-continue">
                                        <div class="elm-btn">
                                                <a href="#" class="themesflat-button outline ol-accent margin-top-40 hvr-shutter-out-horizontal">CONTINUE SHOPPING</a>
                                        </div>
                                    </div>
                                    <div class="btn-clear">
                                        <ul>
                                            <li>
                                                <div class="elm-btn">
                                                    <a href="#" class="themesflat-button outline ol-accent margin-top-40 hvr-shutter-out-horizontal">CLEAR CART</a>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="elm-btn">
                                                    <a href="#" class="themesflat-button outline ol-accent margin-top-40 hvr-shutter-out-horizontal">UPDATE CART</a>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="wrap-discount-estimate-cart">
                                        ...
                                        <div class="col-lg-4 col-md-4 cart">
                                            ...
                                            <div class="elm-btn">
                                                <a href="#" class="themesflat-button outline ol-accent margin-top-40 hvr-shutter-out-horizontal">PROCEED TO CHECK OUR</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="tab-reviews" class="tab-content">
                                        ...
                                        <form class="form-checkout " >
                                            <div class="row-input-wrap clearfix">
                                                <div class="input-wrap float-left-50 pd-right-10">
                                                    ...
                                                    <input type="text" name="name" required="" class="width-100">
                                                </div>
                                            ...
                                            <div class="input-wrap">
                                                ...
                                                <input type="text"    required="" placeholder="United States" class="width-100" >
                                            </div>
                                            <div class="input-wrap">
                                                <label>Address<span> *</span></label>
                                                <input type="text"  class="mg-bottom-25 width-100" required="" placeholder="100A 8th St, Los Angeles, CA 90014"  >
                                            </div>
                                            <div class="input-wrap">
                                    ...
                                    <div class="review-order">
                                        ...
                                        <div class="wrap-check mg-top-20">
                                            ...
                                            <div class="input-wrap mg-bottom-15">
                                                <input type="checkbox" name="paypal"> PAYPAL<img src="${contextRoot}/FrontPage/image/homepage136.png" alt="image">
                                            </div>
